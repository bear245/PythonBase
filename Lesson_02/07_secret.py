...
# Decoding all words
firstKey = secret_message[0][3] + ' '
secondKey = secret_message[1][9:13] + ' '
thirdKey = secret_message[2][5:15:2] + ' '
fourthKey = secret_message[3][7:13] + ' '
fifthKey = secret_message[4][16:21] + ' '

# Output concatenated sting
print(firstKey + secondKey + thirdKey + fourthKey[::-1] + fifthKey[::-1])